...
import ui.form.employee.controler.EmployeeDetailsFormControler;

/**
 *
  @author Jelena Basaric
 */
public class EmployeeDetailsForm extends javax.swing.JDialog {
     ...
     */
    public EmployeeDetailsForm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void btnAddEmployeeActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddEmployeeActionPerformed
        EmployeeDetailsFormControler.addOrUpdateEmployee(txtFirstName,txtLastName,txtAdrress,txtAdrress,txtEmail,txtPhoneNumber,txtSalary,txtError,txtDOB,rbtnFemale,rbtnMale,rbtnUnknown,cmbCity,cmbRole,employeeService);
    ...
    private void populateComboCity() {
        EmployeeDetailsFormControler.populateComboCity(cityService, cmbCity);
            }

     private void populateComboRole() {
         EmployeeDetailsFormControler.populateComboRole(roleService, cmbRole);
     }

    private void prepareForm() {
        EmployeeDetailsFormControler.prepareForm(txtFirstName,txtLastName,txtAdrress,txtAdrress,txtEmail,txtPhoneNumber,txtSalary,txtError,txtDOB,rbtnFemale,rbtnMale,rbtnUnknown,cmbCity,cmbRole,employeeService);
    }
}
